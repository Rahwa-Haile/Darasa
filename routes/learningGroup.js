...
const {createLearningGroup, getAllLearningGroups, getLearningGroup, updateLearningGroup, deleteLearningGroup} = require('../controllers/learningGroup')
...
router.patch('/learningGroup/:id', updateLearningGroup)
